...
//---------------------------------------------------------------------------//
// Class: LogicCanBuildCity
// 
// Mixin container for logic that determines if the
// city <BuildUI> should be visible, which is true
// if the player can build a city and has a place to
...
IMPLEMENT_LOGIC(LogicCanBuildCity, STANDARD)
