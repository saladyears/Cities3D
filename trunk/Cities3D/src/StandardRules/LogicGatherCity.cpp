...
//     <Standard>
//
class LogicGatherCity : public Logic
{
public:
	virtual void Decide(const DataObject &input, DataObject &output)
	{
		...
		// They get two resources of the given type for having a city.
...
IMPLEMENT_LOGIC(LogicGatherCity, STANDARD)
