...
//---------------------------------------------------------------------------//
// Class: RuleRestartSecondSettlement
// 
// Restarts the <Game> from the State of SecondSettlement.
//
// Derived From:
//     <Rule>
//
...
//     eventControlsUI
//
class RuleRestartSecondSettlement : public Rule
{
public:
...
IMPLEMENT_RULE_KEYED_MIXIN(RuleRestartSecondSettlement, SecondSettlement, 
