...
//---------------------------------------------------------------------------//
// Class: LogicCanShowCard
// 
// Mixin container for logic that determines whether a player can show the card
// window.
//
// Derived From:
//     <LogicBooleanMixin>
...
//     <Standard>
//
class LogicCanShowCard : public LogicBooleanMixin<false>
{
...
IMPLEMENT_LOGIC(LogicCanShowCard, STANDARD);
