...
//     <RulePlayCard>
//
class RulePlayCardMonopoly : public Rule
{
public:
	virtual void Execute(const DataObject &object)
	{
		...
		// They have now played a card this turn.
		...
		// stops.
		gameData<HashString>(shState) = shTurnMonopoly;

		// Just use the restart logic to fire up the dialog.
		RULE.Execute(shRuleRestartTurnMonopoly, DataObject());
	}
};

IMPLEMENT_RULE_KEYED_MIXIN(RulePlayCardMonopoly, Monopoly, 
