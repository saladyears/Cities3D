...
//---------------------------------------------------------------------------//
// Class: RuleBuildSettlement
// 
// Mixin container for handling a user click on the settlement 
...
public:
	virtual void Execute(const DataObject &object)
	{
		...
		{
			wxLogError(
				wxT("Programmer Error: No State %s in RuleBuildSettlement"), 
				state.cwx_str());
		}
	}
...
IMPLEMENT_RULE(RuleBuildSettlement, STANDARD)
