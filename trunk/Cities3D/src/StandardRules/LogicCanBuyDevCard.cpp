...
//---------------------------------------------------------------------------//
// Class: LogicCanBuyDevCard
// 
// Mixin container for logic that determines if the
// dev card <BuildUI> should be visible, which is true
// if the player can buy a dev card and if there some still
// left in the bank.  Looks up the <ILogic> in its
...
IMPLEMENT_LOGIC(LogicCanBuyDevCard, DEVCARDS)
