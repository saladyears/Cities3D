...
//---------------------------------------------------------------------------//
// Class: LogicCanBuildRoad
// 
// Mixin container for logic that determines if the
// road <BuildUI> should be visible, which is true
// if the player can build a road and has a place to
...
IMPLEMENT_LOGIC(LogicCanBuildRoad, STANDARD)
