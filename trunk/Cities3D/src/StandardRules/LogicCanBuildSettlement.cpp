...
//---------------------------------------------------------------------------//
// Class: LogicCanBuildSettlement
// 
// Mixin container for logic that determines if the
// settlement <BuildUI> should be visible, which is true
// if the player can build a settlement and has a place to
...
IMPLEMENT_LOGIC(LogicCanBuildSettlement, STANDARD)
