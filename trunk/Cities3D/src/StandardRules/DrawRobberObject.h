...
//---------------------------- CLASSES          -----------------------------//
class DrawRobberObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawRobberObject, RobberObject)

public:
	DrawRobberObject(const GameObjectPtr &object);
	virtual ~DrawRobberObject();
