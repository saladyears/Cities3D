...
//     <Standard>
//
class RuleExecuteLose7 : public Rule
{
public:
	virtual void Execute(const DataObject &object)
	{
		...
		str = wxString::Format(stLoses.c_str(), swStringFormat.c_str(), str.c_str());
		
		// This player no longer needs to lose cards.
		playerGameData<wxInt32>(shLoseCards, curPlayer) = FALSE;
		...
		RULE.Execute(shRuleRestartTurnLose7, DataObject(false));
	}
};

IMPLEMENT_RULE(RuleExecuteLose7, STANDARD)
