...
//---------------------------- CLASSES          -----------------------------//
class DrawSettlementObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawSettlementObject, SettlementObject)

public:
	DrawSettlementObject(const GameObjectPtr &object);
	virtual ~DrawSettlementObject();
