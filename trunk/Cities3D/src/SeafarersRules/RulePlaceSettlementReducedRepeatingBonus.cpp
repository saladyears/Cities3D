...
//---------------------------------------------------------------------------//
// Class: RulePlaceSettlementReducedRepeatingBonus
// 
...
//
class RulePlaceSettlementReducedRepeatingBonus : public Rule
{
public:
...
IMPLEMENT_RULE_MIXIN(RulePlaceSettlementReducedRepeatingBonus, 
					 RulePlaceSettlementReduced, REPEATING_BONUS)
