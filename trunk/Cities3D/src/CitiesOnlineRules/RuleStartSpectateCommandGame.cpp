...
//---------------------------------------------------------------------------//
// Class: RuleStartSpectateCommandGame
// 
// Starts a game in response to a spectate command.
//
// Derived From:
//     <Rule>
//
...
//
//
class RuleStartSpectateCommandGame : public Rule
{
public:
...
IMPLEMENT_RULE(RuleStartSpectateCommandGame, CITIESONLINE)
