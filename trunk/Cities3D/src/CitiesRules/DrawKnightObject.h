...
//---------------------------- CLASSES          -----------------------------//
class DrawKnightObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawKnightObject, KnightObject)

public:
	DrawKnightObject(const GameObjectPtr &object);
	virtual ~DrawKnightObject();
