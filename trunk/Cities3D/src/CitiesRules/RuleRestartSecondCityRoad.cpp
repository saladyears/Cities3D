...
//---------------------------------------------------------------------------//
// Class: RuleRestartSecondCityRoad
// 
// Restarts the <Game> from the State of SecondCityRoad.
//
// Derived From:
//     <Rule>
//
...
//     eventControlsUI
//
class RuleRestartSecondCityRoad : public Rule
{
public:
...
IMPLEMENT_RULE_KEYED_MIXIN(RuleRestartSecondCityRoad, SecondCityRoad, 
