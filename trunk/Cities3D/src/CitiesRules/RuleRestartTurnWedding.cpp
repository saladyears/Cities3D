...
//---------------------------------------------------------------------------//
// Class: RuleRestartTurnWedding
// 
// Restarts the game from players losing cards to a wedding.
//
// Derived From:
//     <Rule>
//
...
//     <RuleRestartGame>
//
class RuleRestartTurnWedding : public Rule
{
public:
...
IMPLEMENT_RULE_KEYED_MIXIN(RuleRestartTurnWedding, TurnWedding, 
