...
//---------------------------------------------------------------------------//
// Class: LogicIsCardPlayableWedding
// 
// Determines whether the Wedding card is playable right now.
//
// Derived From:
//     <Logic>
//
...
//     <LogicIsCardPlayable>
//
class LogicIsCardPlayableWedding : public Logic
{
public:
...
IMPLEMENT_LOGIC_KEYED_MIXIN(LogicIsCardPlayableWedding, Wedding,
