...
//---------------------------------------------------------------------------//
// Class: RuleRestartTurnInventor
// 
// Restarts the game from a player selecting the first tile to switch.
//
// Derived From:
//     <Rule>
//
...
//     <RuleRestartGame>
//
class RuleRestartTurnInventor : public Rule
{
public:
	virtual void Execute(const DataObject &)
	{
		...
		RULE.Execute(shRuleUpdateMessageUI, DataObject(stSelectTheFirstRollChip, 
            stWaitingSelectTheFirstRollChip));
		...
		Controller::get().Transmit(shEventSelectionObject, 
			SelectionObjectPtr(
			new DummySelectionObject(shRuleSelectFirstInventorChip)));
...
IMPLEMENT_RULE_KEYED_MIXIN(RuleRestartTurnInventor, TurnInventor, 
