...
//---------------------------- PUBLIC           -----------------------------//
class KnightErrantOptions : public IOptionUI
{
public:
	...
	{
		return stAllowsPlayersToUseAnActiveKnight;
	}
...
IMPLEMENT_OPTION_UI(KNIGHT_ERRANT, KnightErrantOptions);
