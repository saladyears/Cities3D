...
//---------------------------- CLASSES          -----------------------------//
class DrawWallsObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawWallsObject, WallsObject)

public:
	DrawWallsObject(const GameObjectPtr &object);
	virtual ~DrawWallsObject();
