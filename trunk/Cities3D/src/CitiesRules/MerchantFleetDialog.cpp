...
namespace
{
	class LogicMerchantFleet : public SelectionLogic
	{
	public:
		LogicMerchantFleet(boost::weak_ptr<Game> game) 
			: SelectionLogic(game) {}
		...
		virtual void Initialize()
		{
			...
			text->SetLabel(stSelectOneCardTypeToTrade);
		}
...
//---------------------------- PUBLIC           -----------------------------//
wxMerchantFleetDialog::wxMerchantFleetDialog(wxWindow *parent, 
	boost::weak_ptr<Game> game)
: wxResourceSelectionDialog(parent, game, SelectionLogicPtr(new LogicMerchantFleet(game)),
	shRuleExecuteMerchantFleetCard, stMerchantFleet)
{
}
