...
//---------------------------- CLASSES          -----------------------------//
class DrawMerchantObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawMerchantObject, MerchantObject)

public:
	DrawMerchantObject(const GameObjectPtr &object);
	virtual ~DrawMerchantObject();
