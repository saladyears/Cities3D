...
//---------------------------------------------------------------------------//
// Class: LogicCanUpgrade2KnightTurn
// 
...
//
// Mixin To:
//     <LogicCanUpgrade2Knight>
//
// Logic Called:
//     <LogicCanPurchaseKnight>
//
class LogicCanUpgrade2KnightTurn : public Logic
{
public:
	virtual void Decide(const DataObject &input, DataObject &output)
	{
		// There are three conditions that must be met in order for a player to
		// be allowed to upgrade to a strong knight:
		// 
		// 1) They must have at least one strong knight in stock.
		// 2) They must have the resources to purchase a knight.
		// 3) They must have a basic knight on the board to replace.
		//
		...
		// Condition 1.
		if(0 < playerGameData<wxInt32>(shStockKnights2))
		{
			// Condition 2.
...
IMPLEMENT_LOGIC_KEYED_MIXIN(LogicCanUpgrade2KnightTurn, Turn,
							LogicCanUpgrade2Knight, CITIES)
