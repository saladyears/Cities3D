...
//     <Cities>
//
class RulePlayProgressCardEnd : public Rule
{
public:
	virtual void Execute(const DataObject &)
	{
		...
		// Update controls ui as this may affect bank trades.
...
IMPLEMENT_RULE(RulePlayProgressCardEnd, CITIES)
