...
//---------------------------- TYPEDEFS         -----------------------------//
class MetropolisObject;

//---------------------------- CLASSES          -----------------------------//
class DrawMetropolisObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawMetropolisObject, MetropolisObject)

public:
	DrawMetropolisObject(const GameObjectPtr &object);
	virtual ~DrawMetropolisObject();
