...
//---------------------------------------------------------------------------//
// Class: RuleExecuteTradeMonopolyCard
// 
// Takes the given commodity from all players and gives it to the current
// player, to a maximum of 1 card.
//
// Derived From:
//     <Rule>
//
...
//     <Cities>
//
class RuleExecuteTradeMonopolyCard : public Rule
{
public:
...
IMPLEMENT_RULE(RuleExecuteTradeMonopolyCard, CITIES)
