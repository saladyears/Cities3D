...
//---------------------------------------------------------------------------//
// Class: LogicCostUpgradeTrade
// 
// Returns the cost in resources to upgrade trade.
//
// Derived From:
//     <Logic>
//
...
//     <Cities>
//
class LogicCostUpgradeTrade : public Logic
{
public:
	virtual void Decide(const DataObject &, DataObject &output)
	{
		...
		wxInt32 cost = playerGameData<wxInt32>(shTradeLevel) + 1;
