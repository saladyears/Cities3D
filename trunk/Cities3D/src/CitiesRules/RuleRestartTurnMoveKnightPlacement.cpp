...
//---------------------------------------------------------------------------//
// Class: RuleRestartTurnMoveKnightPlacement
// 
...
//
class RuleRestartTurnMoveKnightPlacement : public Rule
{
public:
	virtual void Execute(const DataObject &)
	{
		...
		HashString rule = shRulePlaceMoveKnight;
		...
		// Update the UI text.
		RULE.Execute(shRuleUpdateMessageUI, DataObject(stMoveYourKnight, 
            stWaitingMoveAKnight));
	}
...
IMPLEMENT_RULE_KEYED_MIXIN(RuleRestartTurnMoveKnightPlacement, 
						   TurnMoveKnightPlacement, RuleRestartGame, CITIES)
