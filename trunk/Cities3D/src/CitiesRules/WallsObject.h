...
//---------------------------- CLASSES          -----------------------------//
class WallsObject : public ExtraCornerObject
{
	DECLARE_GAME_OBJECT(WallsObject);

public:
	WallsObject(wxInt32 owner, wxInt32 turn, const ColorType color, 
	...
	{
		return Vector(0.0f, -0.2777f, 0.0f);
	}
};

//---------------------------- PROTOTYPES       -----------------------------//
IMPLEMENT_GAME_OBJECT(WallsObject, CITIES);
