...
namespace
{
	struct PopulateFunctionSteal
	{
		PopulateFunctionSteal(wxInt32 victim)
			: mVictim(victim)
		{}
		...
		void operator()(const GamePtr& game, wxInt32, 
            wxCardListCtrl::CardArray& cards)
		{
...
//---------------------------- PUBLIC           -----------------------------//
wxStealProgressCardListCtrl::wxStealProgressCardListCtrl(wxWindow* parent, 
	wxWindowID id, boost::weak_ptr<Game> game, wxInt32 victim, 
	const wxPoint& pos, const wxSize& size)
	: wxCardListCtrl(parent, id, game, PopulateFunctionSteal(victim), pos, size)
{
}
