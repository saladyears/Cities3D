...
//---------------------------------------------------------------------------//
// Class: DrawCornerSelectionObject
// 
// Needs documentation.
//
// Derived From:
...
//
class DrawCornerSelectionObject : public DrawObject
{
	DECLARE_DRAW_OBJECT(DrawCornerSelectionObject, CornerSelectionObject)

public:
	DrawCornerSelectionObject(const GameObjectPtr &object);
	virtual ~DrawCornerSelectionObject();
