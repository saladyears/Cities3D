...
namespace
{
	wxString sFields_Spectator[] = {swSpectator};
}
...
wxSpectatorListCtrl::wxSpectatorListCtrl(wxWindow* parent, wxWindowID id, 
										 const wxPoint& pos, 
										 const wxSize& size)
: wxBaseListCtrl(parent, id, sFields_Spectator, _countof(sFields_Spectator), 
				 shSpectatorListMainFont, shSpectatorListSubFont, pos, size)
{
