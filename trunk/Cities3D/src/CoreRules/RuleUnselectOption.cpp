...
//---------------------------------------------------------------------------//
// Class: RuleUnselectOption
// 
// Unselects the given option in the OptionEngine.
//
// Derived From:
//     <Rule>
//
...
//     eventPreGame
//
class RuleUnselectOption : public Rule
{
public:
	virtual void Execute(const DataObject &object)
	{
		...
		OPTION.UnselectOption(module, option);
...
IMPLEMENT_RULE(RuleUnselectOption, CORE)
