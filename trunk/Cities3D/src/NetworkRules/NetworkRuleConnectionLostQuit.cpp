...
//---------------------------------------------------------------------------//
// Class: NetworkRuleConnectionLostQuit
// 
// Handles a player quitting from a network game.
//
// Derived From:
//     <Rule>
//
...
//
class NetworkRuleConnectionLostQuit : public Rule
{
public:
	virtual void Execute(const DataObject &object)
	{
		...
		wxString str = wxString::Format(stQuitsTheGame.c_str(),
			player.Name().c_str());
...
IMPLEMENT_RULE_KEYED_MIXIN(NetworkRuleConnectionLostQuit, Quit,
