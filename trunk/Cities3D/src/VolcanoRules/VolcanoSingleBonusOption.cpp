...
//---------------------------- PUBLIC           -----------------------------//
class VolcanoSingleBonusOption : public IOptionUI
{
public:
	virtual void dependencies(StringPairArray& array) const
	{
		array.push_back(std::make_pair(swSeafarersRules, 
			swSingleBonus));
...
IMPLEMENT_OPTION_UI(VOLCANO_SINGLE_BONUS, VolcanoSingleBonusOption);
